...
class _SuccessResult<F, V> implements Result<F, V> {
  ...
  @override
  TResult? onSuccess<TResult>(TResult Function(V value) onSuccess) => onSuccess.call(_value);
  ...
  @override
  F? get failureresult => null;

  @override
  V? get succesResult => _value;
}
...
class _FailureResult<F, V> implements Result<F, V> {
  ...
  @override
  TResult? onFailure<TResult>(TResult Function(F failure) onFailure) => onFailure.call(_failure);
  ...
  @override
  F? get failureresult => _failure;

  @override
  V? get succesResult => null;
}
